...
public class SymbolAlternationImpl extends ASTWrapperPsiElement implements ISymbol {

    public SymbolAlternationImpl(ASTNode node) { super(node); }
    ...
    public ISymbols getSymbols() { return findNotNullChildByClass(ISymbols.class); }
    public List<PsiElement> getSymbolsList() { return findNotNullChildByClass(IEbnfElement.class).getElements(); }
