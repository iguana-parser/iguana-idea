...
public class SymbolConditionalImpl extends ASTWrapperPsiElement implements ISymbol {

    public SymbolConditionalImpl(ASTNode node) { super(node); }

    public void accept(PsiElementVisitor visitor) { super.accept(visitor); }

    public ISymbol getSymbol() { return null; }
    public List<ISymbol> getAllSymbol() { return PsiTreeUtil.getChildrenOfTypeAsList(this, ISymbol.class); }
