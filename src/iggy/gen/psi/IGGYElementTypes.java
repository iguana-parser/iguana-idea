...
public interface IGGYElementTypes {
    ...
    public IElementType REGEXRULE_REGEX = new IGGYElementType("REGEXRULE_REGEX");
    ...
    public IElementType REGEX_CHARACTER = new IGGYElementType("REGEX_CHARACTER");
    ...
    public IElementType ALTERNATES_PREC = new IGGYElementType("ALTERNATES_PREC");
    ...
    public IElementType SYMBOL_CHARACTER = new IGGYElementType("SYMBOL_CHARACTER");
    ...
    public IElementType AATTRIBUTE_ASSOC = new IGGYElementType("AATTRIBUTE_ASSOC");
    public IElementType SYMBOLS_SEQUENCE = new IGGYElementType("SYMBOLS_SEQUENCE");
    ...
    public IElementType RANGE_CHARACTER = new IGGYElementType("RANGE_CHARACTER");
    public IElementType RANGE_RANGE = new IGGYElementType("RANGE_RANGE");
    public IElementType RULE = new IGGYElementType("RULE");
    public IElementType RULE_SYNTAX = new IGGYElementType("RULE_SYNTAX");
    public IElementType ATTRIBUTE = new IGGYElementType("ATTRIBUTE");
    public IElementType LABEL = new IGGYElementType("LABEL");
    public IElementType LATTRIBUTE_LABEL = new IGGYElementType("LATTRIBUTE_LABEL");
    ...
    public IElementType REGEXSEQUENCE_SEQUENCE = new IGGYElementType("REGEXSEQUENCE_SEQUENCE");
    public IElementType RETURNEXPRESSION_RETURNEXPRESSION = new IGGYElementType("RETURNEXPRESSION_RETURNEXPRESSION");
    public IElementType PARAMETERS = new IGGYElementType("PARAMETERS");
    public IElementType REGEXS_SEQUENCE = new IGGYElementType("REGEXS_SEQUENCE");
    public IElementType SEQUENCE_SINGLE = new IGGYElementType("SEQUENCE_SINGLE");
    public IElementType SEQUENCE_MORETHANTWO = new IGGYElementType("SEQUENCE_MORETHANTWO");
    public IElementType IDENTIFIER_IDENT = new IGGYElementType("IDENTIFIER_IDENT");
    ...
    public IElementType BINDING_ASSIGN = new IGGYElementType("BINDING_ASSIGN");
    public IElementType BINDING_DECLARE = new IGGYElementType("BINDING_DECLARE");
    public IElementType START_DEFINITION_START = new IGGYElementType("START_DEFINITION_START");
    ...
    public static IElementType get(String name) {
        switch (name) {
            ...
            case "ALTERNATES_PREC": return ALTERNATES_PREC;
            ...
            case "SYMBOL_CHARACTER": return SYMBOL_CHARACTER;
            ...
            case "AATTRIBUTE_ASSOC": return AATTRIBUTE_ASSOC;
            case "SYMBOLS_SEQUENCE": return SYMBOLS_SEQUENCE;
            ...
            case "RANGE_CHARACTER": return RANGE_CHARACTER;
            case "RANGE_RANGE": return RANGE_RANGE;
            case "RULE": return RULE;
            case "RULE_SYNTAX": return RULE_SYNTAX;
            case "ATTRIBUTE": return ATTRIBUTE;
            case "LABEL": return LABEL;
            case "LATTRIBUTE_LABEL": return LATTRIBUTE_LABEL;
            case "DEFINITION": return DEFINITION;
            case "TAG": return TAG;
            case "WHITESPACEORCOMMENT": return WHITESPACEORCOMMENT;
            case "ARGUMENTS": return ARGUMENTS;
            case "REGEXBODY": return REGEXBODY;
            case "REGEXSEQUENCE_SEQUENCE": return REGEXSEQUENCE_SEQUENCE;
            case "RETURNEXPRESSION_RETURNEXPRESSION": return RETURNEXPRESSION_RETURNEXPRESSION;
            case "PARAMETERS": return PARAMETERS;
            case "REGEXS_SEQUENCE": return REGEXS_SEQUENCE;
            case "SEQUENCE_SINGLE": return SEQUENCE_SINGLE;
            case "SEQUENCE_MORETHANTWO": return SEQUENCE_MORETHANTWO;
            case "IDENTIFIER_IDENT": return IDENTIFIER_IDENT;
            case "CHARCLASS_NOTCHARS": return CHARCLASS_NOTCHARS;
            case "CHARCLASS_CHARS": return CHARCLASS_CHARS;
            case "BODY": return BODY;
            case "LAYOUT": return LAYOUT;
            case "BINDING_ASSIGN": return BINDING_ASSIGN;
            case "BINDING_DECLARE": return BINDING_DECLARE;
            case "START_DEFINITION_START": return START_DEFINITION_START;
        }
    ...
    class Factory {
        public static PsiElement createElement(ASTNode node) {
            ...
            if (type == REGEXRULE_REGEX) return new RegexRuleRegexImpl(node);
            ...
            if (type == REGEX_CHARACTER) return new RegexCharacterImpl(node);
            ...
            if (type == ALTERNATES_PREC) return new AlternatesPrecImpl(node);
            ...
            if (type == SYMBOL_CHARACTER) return new SymbolCharacterImpl(node);
            ...
            if (type == AATTRIBUTE_ASSOC) return new AAttributeAssocImpl(node);
            if (type == SYMBOLS_SEQUENCE) return new SymbolsSequenceImpl(node);
            ...
            if (type == RANGE_CHARACTER) return new RangeCharacterImpl(node);
            if (type == RANGE_RANGE) return new RangeRangeImpl(node);
            if (type == RULE) return new RuleImpl(node);
            if (type == RULE_SYNTAX) return new RuleSyntaxImpl(node);
            if (type == ATTRIBUTE) return new AttributeImpl(node);
            if (type == LABEL) return new LabelImpl(node);
            if (type == LATTRIBUTE_LABEL) return new LAttributeLabelImpl(node);
            ...
            if (type == REGEXSEQUENCE_SEQUENCE) return new RegexSequenceSequenceImpl(node);
            if (type == RETURNEXPRESSION_RETURNEXPRESSION) return new ReturnExpressionReturnExpressionImpl(node);
            if (type == PARAMETERS) return new ParametersImpl(node);
            if (type == REGEXS_SEQUENCE) return new RegexsSequenceImpl(node);
            if (type == SEQUENCE_SINGLE) return new SequenceSingleImpl(node);
            if (type == SEQUENCE_MORETHANTWO) return new SequenceMoreThanTwoImpl(node);
            if (type == IDENTIFIER_IDENT) return new IdentifierIdentImpl(node);
            ...
            if (type == BINDING_ASSIGN) return new BindingAssignImpl(node);
            if (type == BINDING_DECLARE) return new BindingDeclareImpl(node);
            if (type == START_DEFINITION_START) return new Start_DefinitionStartImpl(node);
            throw new RuntimeException("Should not have happened!");
        }
    }
}
